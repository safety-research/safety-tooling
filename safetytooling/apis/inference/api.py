...
from .runpod_vllm import CHAT_COMPLETION_VLLM_MODELS, COMPLETION_VLLM_MODELS, VLLM_MODELS, VLLMChatModel
...
class InferenceAPI:
    ...
    def model_id_to_class(
        ...
        elif model_id in VLLM_MODELS or model_id in CHAT_COMPLETION_VLLM_MODELS or model_id in COMPLETION_VLLM_MODELS:
            return self._vllm
