...
_gopher_base_model_fs = """<USER>OK Gopher, I'm going to start by quizzing you with a few warm-up questions. Who is currently the president of the USA?</USER>
...
class Prompt(HashableBaseModel):
    ...
    def gopher_format(self) -> "Prompt":
        ...
        out += "<GOPHER>"
        return Prompt(messages=[ChatMessage(role=MessageRole.user, content=out)]) # base models are just prompted with user role
